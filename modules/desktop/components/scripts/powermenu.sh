...
# Copy from https://github.com/jluttine/rofi-power-menu/tree/master
set -e
set -u

# All supported choices
all=(shutdown reboot suspend hibernate)
...
while true; do
  ...
  "-h" | "--help")
    ...
    echo "                     as the separator. Available choices are suspend, hibernate,"
    echo "                     reboot and shutdown. By default, all available choices are"
    echo "                     shown."
    echo "  --confirm CHOICES  Require confirmation for the gives choices only. Use / as"
    echo "                     the separator. Available choices are suspend, hibernate,"
    echo "                     reboot and shutdown. By default, only irreversible actions "
    echo "                     reboot and shutdown require"
    echo "                     confirmation."
    ...
    echo "                     Available choices are suspend, hibernate, reboot, shutdown."
